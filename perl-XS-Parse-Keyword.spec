...
Source0  : https://cpan.metacpan.org/authors/id/P/PE/PEVANS/XS-Parse-Keyword-0.44.tar.gz
...
%prep
%setup -q -n XS-Parse-Keyword-0.44
cd %{_builddir}/XS-Parse-Keyword-0.44
pushd ..
cp -a XS-Parse-Keyword-0.44 buildavx2
popd
