...
Source0  : https://cpan.metacpan.org/authors/id/P/PE/PEVANS/XS-Parse-Keyword-0.47.tar.gz
...
%prep
%setup -q -n XS-Parse-Keyword-0.47
cd %{_builddir}/XS-Parse-Keyword-0.47
pushd ..
cp -a XS-Parse-Keyword-0.47 buildavx2
popd
