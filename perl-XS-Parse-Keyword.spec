...
%prep
%setup -q -n XS-Parse-Keyword-0.31
cd %{_builddir}/XS-Parse-Keyword-0.31
...
cp %{_builddir}/XS-Parse-Keyword-%{version}/LICENSE %{buildroot}/usr/share/package-licenses/perl-XS-Parse-Keyword/1a0db8ae53618717535b6c54006100fc3e919f87 || :
if test -f Makefile.PL; then
...
/usr/share/package-licenses/perl-XS-Parse-Keyword/1a0db8ae53618717535b6c54006100fc3e919f87
