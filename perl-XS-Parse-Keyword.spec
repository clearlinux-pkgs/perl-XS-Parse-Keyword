...
Source0  : https://cpan.metacpan.org/authors/id/P/PE/PEVANS/XS-Parse-Keyword-0.36.tar.gz
...
%prep
%setup -q -n XS-Parse-Keyword-0.36
cd %{_builddir}/XS-Parse-Keyword-0.36
pushd ..
cp -a XS-Parse-Keyword-0.36 buildavx2
popd
