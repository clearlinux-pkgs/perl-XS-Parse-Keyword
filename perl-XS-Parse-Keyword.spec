...
Source0  : https://cpan.metacpan.org/authors/id/P/PE/PEVANS/XS-Parse-Keyword-0.34.tar.gz
...
%prep
%setup -q -n XS-Parse-Keyword-0.34
cd %{_builddir}/XS-Parse-Keyword-0.34
pushd ..
cp -a XS-Parse-Keyword-0.34 buildavx2
popd
