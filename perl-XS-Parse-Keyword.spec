...
Source0  : https://cpan.metacpan.org/authors/id/P/PE/PEVANS/XS-Parse-Keyword-0.38.tar.gz
...
%prep
%setup -q -n XS-Parse-Keyword-0.38
cd %{_builddir}/XS-Parse-Keyword-0.38
pushd ..
cp -a XS-Parse-Keyword-0.38 buildavx2
popd
